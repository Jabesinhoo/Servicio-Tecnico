...
module.exports = (sequelize, DataTypes) => {
  const Product = sequelize.define(
    'Product',
    {
      ...
      imagenes: { type: DataTypes.JSONB, defaultValue: [] }, // Nuevo campo para fotos
      categoria_id: { type: DataTypes.UUID, allowNull: true }, // Nueva columna
    },
    {
      tableName: 'products',
      timestamps: true,
  ...
  Product.associate = (models) => {
    ...
    Product.belongsTo(models.CategoriaProducto, { foreignKey: 'categoria_id' });
  };
