// src/pages/Dashboard/tecnicos/components/TecnicoFilters.jsx
...
const TecnicoFilters = ({ filters, onFilterChange, onClearFilters, onSearch }) => {
  ...
  const hasFilters = filters.estado !== 'todos' || filters.search !== '';
